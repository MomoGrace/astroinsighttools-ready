...
function BigThreeTool({ navigate }: { navigate: NavFn }) {
...
function PlanetSignTool({ navigate }: { navigate: NavFn }) {
...
function GenericPlanetSignTool({ planetName, subtitle, viewTag, navigate }: { planetName: string; subtitle: string; viewTag: string; navigate: NavFn }) {
...
function AspectTool({ navigate }: { navigate: NavFn }) {
...
function PlanetInHouseTool({ navigate }: { navigate: NavFn }) {
...
function ZodiacCalculatorTool({ navigate }: { navigate: NavFn }) {
...
const slugToTool: Record<string, (props: { navigate: NavFn }) => React.ReactElement> = {
  ...
  'rising-sign-estimator': (p) => <RisingSignEstimatorTool {...p} />,
  'birth-chart-checklist': (p) => <BirthChartChecklistTool {...p} />,
  'zodiac-calculator': (p) => <ZodiacCalculatorTool {...p} />,
  'moon-phase': (p) => <MoonPhaseTool {...p} />,
  'daily-horoscope': (p) => <DailyHoroscopeTool {...p} />,
  'horoscope-2026': (p) => <Horoscope2026Tool {...p} />,
  ...
  'personal-year': (p) => <PersonalYearTool {...p} />,
  'angel-number': (p) => <AngelNumberTool {...p} />,
  'chinese-zodiac': (p) => <ChineseZodiacTool {...p} />,
  'five-elements': (p) => <FiveElementsTool {...p} />,
  'lucky-color': (p) => <LuckyColorTool {...p} />,
  'lucky-number': (p) => <LuckyNumberTool {...p} />,
  'birthday-personality': (p) => <BirthdayPersonalityTool {...p} />,
  'career-personality': (p) => <CareerPersonalityTool {...p} />,
  'zodiac-money-style': (p) => <ZodiacMoneyStyleTool {...p} />,
  'birth-time-unknown': (p) => <BirthTimeUnknownTool {...p} />,
  'yes-no-tarot': (p) => <YesNoTarotTool {...p} />,
};
...
export default function ToolSlugPage() {
  ...
  return <ToolComponent navigate={navigate} />;
}
