      ...
      <section className="max-w-6xl mx-auto px-4 py-12">
        ...
        <div className="max-w-2xl mx-auto">
          <Accordion type="single" collapsible className="w-full">
            <AccordionItem value="q1"><AccordionTrigger>Are Astro Insight Tools free to use?</AccordionTrigger><AccordionContent>Yes. Our astrology and numerology tools are free browser-based tools for entertainment and self-reflection. No account is needed to use any tool or read any guide.</AccordionContent></AccordionItem>
            <AccordionItem value="q2"><AccordionTrigger>Do I need exact birth time for every tool?</AccordionTrigger><AccordionContent>No. Many tools can still be used without exact birth time. Rising sign and house-based interpretations are more time-sensitive, but most of our interpretation tools work with the information you already know about your chart.</AccordionContent></AccordionItem>
            <AccordionItem value="q3"><AccordionTrigger>Are these results professional advice?</AccordionTrigger><AccordionContent>No. Results are for entertainment and self-reflection only, and are not medical, legal, financial, or psychological advice. Always consult qualified professionals for important life decisions.</AccordionContent></AccordionItem>
          </Accordion>
        </div>
      </section>
    </div>
