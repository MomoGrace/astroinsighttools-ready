      ...
      <section className="max-w-6xl mx-auto px-4 py-12">
        ...
        <div className="max-w-2xl mx-auto">
          <div className="w-full">
            <details className="group border-b"><summary className="flex items-center justify-between py-4 text-sm font-medium cursor-pointer outline-none hover:underline [&::-webkit-details-marker]:hidden list-none">Are Astro Insight Tools free to use?<svg className="text-muted-foreground h-4 w-4 shrink-0 transition-transform duration-200 group-open:rotate-180 ml-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m6 9 6 6 6-6"/></svg></summary><div className="pb-4 text-sm leading-7 text-muted-foreground">Yes. The tools on Astro Insight Tools are free to use for personal entertainment, reflection, and self-discovery.</div></details>
            <details className="group border-b"><summary className="flex items-center justify-between py-4 text-sm font-medium cursor-pointer outline-none hover:underline [&::-webkit-details-marker]:hidden list-none">Do I need my exact birth time for every tool?<svg className="text-muted-foreground h-4 w-4 shrink-0 transition-transform duration-200 group-open:rotate-180 ml-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m6 9 6 6 6-6"/></svg></summary><div className="pb-4 text-sm leading-7 text-muted-foreground">No. Some tools can work with your birth date or zodiac sign only. Tools that involve deeper astrology-style calculations may give more interesting results when you include the correct birth time.</div></details>
            <details className="group border-b"><summary className="flex items-center justify-between py-4 text-sm font-medium cursor-pointer outline-none hover:underline [&::-webkit-details-marker]:hidden list-none">Are these results professional advice?<svg className="text-muted-foreground h-4 w-4 shrink-0 transition-transform duration-200 group-open:rotate-180 ml-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m6 9 6 6 6-6"/></svg></summary><div className="pb-4 text-sm leading-7 text-muted-foreground">No. The results are for entertainment and self-reflection only. They are not financial, medical, legal, psychological, relationship, or spiritual advice.</div></details>
            <details className="group border-b"><summary className="flex items-center justify-between py-4 text-sm font-medium cursor-pointer outline-none hover:underline [&::-webkit-details-marker]:hidden list-none">Why do different tools give different results?<svg className="text-muted-foreground h-4 w-4 shrink-0 transition-transform duration-200 group-open:rotate-180 ml-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m6 9 6 6 6-6"/></svg></summary><div className="pb-4 text-sm leading-7 text-muted-foreground">Each tool looks at a different angle, such as zodiac signs, numerology, compatibility, or personality patterns. The results are meant to be explored as prompts, not as fixed predictions.</div></details>
            <details className="group border-b"><summary className="flex items-center justify-between py-4 text-sm font-medium cursor-pointer outline-none hover:underline [&::-webkit-details-marker]:hidden list-none">Can I use these tools without creating an account?<svg className="text-muted-foreground h-4 w-4 shrink-0 transition-transform duration-200 group-open:rotate-180 ml-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m6 9 6 6 6-6"/></svg></summary><div className="pb-4 text-sm leading-7 text-muted-foreground">Yes. You can use the tools directly in your browser without signing up.</div></details>
            <details className="group border-b"><summary className="flex items-center justify-between py-4 text-sm font-medium cursor-pointer outline-none hover:underline [&::-webkit-details-marker]:hidden list-none">Do you store my birth details or personal information?<svg className="text-muted-foreground h-4 w-4 shrink-0 transition-transform duration-200 group-open:rotate-180 ml-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m6 9 6 6 6-6"/></svg></summary><div className="pb-4 text-sm leading-7 text-muted-foreground">Astro Insight Tools is designed for simple browser-based use. Avoid entering sensitive personal information, and do not use the tools as a place to store private data.</div></details>
            <details className="group border-b"><summary className="flex items-center justify-between py-4 text-sm font-medium cursor-pointer outline-none hover:underline [&::-webkit-details-marker]:hidden list-none">How should I use the results?<svg className="text-muted-foreground h-4 w-4 shrink-0 transition-transform duration-200 group-open:rotate-180 ml-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m6 9 6 6 6-6"/></svg></summary><div className="pb-4 text-sm leading-7 text-muted-foreground">Use the results as a fun starting point for reflection. They can help you think about your personality, relationships, timing, and life patterns, but your own judgment should always come first.</div></details>
          </div>
        </div>
      </section>
      </div>
